...
And all of us in this room, a authors of software we hope will be successful, and in that success, grow, and change, a guiding architectural principle must be the construction of software that is easy to change.
...
And this is my point, the narrative that derides other languages for being bloated, overcomplicated, poorly designed, verbose, unworkable, or just in need of a damn good rewrite, could very well be turned upon Go.
...
Start talking about design, maybe use some of the ideas I presented here, or maybe you do your own research, and apply those ideas to your projects.
