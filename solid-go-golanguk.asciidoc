...
If code review is there to catch bad code, then hopefully all of you who practice code review should be able to recognize good code when you see it.
...
nd we're looking for objective ways to talk about the properties of good code.

But this is the thing, whenever groups of developers discuss a piece of software, inevitably the discussion turns to adjectives like good; good code, good design, good style, and so on.
...
He called these the SOLID principles, after the first letters in their names.
...
The first principle of SOLID, is the single responsibility principle, which states:
...
As authors of software that will be successful, and in that success, grow, and change, a guiding architectural principle must be the construction of software that is easy to change.
...
Instea, substitution is the purview of Go’s interfaces.
...
All five of the SOLID principles relate to the management of dependencies between software units.
...
Last month I was lucky enough to pose this question to Donnie Berkholz, but it turned out he misherd me and instead told me that there are around 25 million programmers in the world today.

But, in his presentation he mentioned that Go has somewhere around a 1% market share.
So, here's my guess:
...
In his keynote late last year, Martin Odesrsky said there are around 100 thousand scala developers.
...
The biggest threat to Go will not be a faster, special purpose language, but the ability of all of us, all Go programmers, as a population, to not make such a mess of it that people start to talk about Go in the way that they joke about Java today.
