...
=== Needlessly complex.
Is there code for the sake of having code, are things overengineered in vain hope that one day you might need to implement some obscure option?
...
// quote, patterns represent deficiency in a langauge
...
The key word there is _change_, software you write, will change over time.
