...
But, when I was talking to Gophers at a conference in London a few months ago, several of them expressed a concern that while _they_ understood the notion of a function that _returns_ a function, the technique that powers function options, they were worried that other Go programmers--I suspect insinuating possibly less experienced programmers--would not be able to understand this style of programming.
